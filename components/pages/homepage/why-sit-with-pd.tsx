...
export default function WhySitWithPd() {
  ...
  return (
    <section className="container mx-auto   pt-15  ">
      ...
      <div className="container mx-auto   flex flex-col lg:flex-row gap-5   max-w-6xl">
        <div className="flex-1 bg-[#CBD4DB66] p-6 rounded-[10px] text-base leading-6 text-[#14312D]">
          <div className="h-10 relative p-1  w-10 rounded-full mb-8 flex items-center justify-center bg-[#25756A1A] ">
            <Image
          ...
          <p className="mb-6">
            ...
            transformative experiences, and meaningful community, we help people
            move from overwhelm and uncertainty to clarity, resilience, and
            purposeful living. While others help people stay afloat in life's
            waters, Sit With PD helps them find their compass, reclaim their
            direction, and sail toward a more purposeful future.
          </p>

          <p>
            We create space to reconnect with who you are, discover where you're
            going, and live with greater intention and purpose.
          </p>
        </div>
        ...
        <div className="flex-1 relative">
          ...
          <p className="text-base text-[#14312D] leading-6 bg-[#ECFCEB] p-4 rounded-[10px] flex flex-col gap-4 max-w-75 absolute bottom-2.5 left-2.5">
            <span>
              <svg
                width="20"
                height="16"
            ...
            all the answers; it begins with sitting with yourself long enough to
            hear them."
          </p>
        </div>
      </div>
