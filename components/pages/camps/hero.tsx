...
export function CampHero() {
  return (
    <section className="w-full">
      <div className="relative w-full min-h-svh md:min-h-[60vh] lg:min-h-dvh flex items-center justify-center  py-24">
        <Image
        ...
        >
          <div className="space-y-4 text-center md:w-10/12 lg:w-2/3  ">
            <motion.h1
              variants={fadeInUp}
              className={`text-[#F9FDF9] heading-1 leading-[1.05] text-start`}
            >
              A space to pause, reflect, and reconnect.
            </motion.h1>
            <motion.p
              variants={fadeInUpSlower}
              className="lg:text-[1.25rem] text-xl text-[#F7FBF6] text-start  sm:w-10/12 md:w-9/12 "
            >
              Three days away from the noise. In nature, with people on the same
              journey guided by those who have walked it too.
            </motion.p>
          </div>
          <motion.div
